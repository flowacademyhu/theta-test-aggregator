...
export class TestDetailsComponent implements OnInit, OnDestroy {
  ...
  public user: User;
  public startTimestampUnix: number;
  public endTimestampUnix: number;
  ...
  ngOnInit(): void {
    ...
    this.startTimestampUnix = this.test.start_timestamp / 1000000;
    this.endTimestampUnix = this.test.end_timestamp / 1000000;
  }
